...
export function RateCalculatorUI() {
 ...
 useEffect(() => {
  // ... (Keep all previous 'else if' blocks for Digital Visual and Radio) ...
   ...
   // Calculator for: TV -> TV + Digital Visual – Paid Social
     ...
     if (combinedRate) {
       ...
       const finalRate = selectedMarket === 'Local/Regional' ? rateParts[0] : rateParts[1];
